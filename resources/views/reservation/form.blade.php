        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="list-group">
                    <a class="list-group-item list-group-item-success" href="#" onclick='document.getElementById("saveCustomerReservationDetails").submit();'><i class="fa fa-check"></i>&nbsp;&nbsp;Create Reservation</a>
